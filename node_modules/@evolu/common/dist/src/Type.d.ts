...
export interface SetType<ElementType extends AnyType> extends Type<"Set", ReadonlySet<InferType<ElementType>>, ReadonlySet<InferInput<ElementType>>, SetError<InferError<ElementType>>, ReadonlySet<InferParent<ElementType>>, SetError<InferParentError<ElementType>>> {
    readonly element: ElementType;
}
export interface SetError<Error extends TypeError = TypeError> extends TypeErrorWithReason<"Set", {
...
export declare const formatSetError: <Error extends TypeError>(formatTypeError: TypeErrorFormatter<Error>) => TypeErrorFormatter<SetError<Error>>;
/**
