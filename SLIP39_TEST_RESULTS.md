...
| JavaScript slip39      | `bb54aac4b89dc868ba37d9cc21b2cece` | ✓ PASS |
...
| JavaScript slip39      | `438c40adb42a0703e501659d5e85c877` | `b1fb5f44`  | ✗              |
...
console.log(
  "Fingerprint:",
  sha256(masterSecretBytes).slice(0, 4).toString("hex"),
);
```
